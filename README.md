...
Plan and rationale: [RUNNER-PLAN.md](./RUNNER-PLAN.md). Strategy: [../uxflows/STRATEGY.md](../uxflows/STRATEGY.md). Editor integration: [../uxflows/SIMULATE-PLAN.md](../uxflows/SIMULATE-PLAN.md).
...
- **Phase 2** 🟡 — editor canvas highlighting from event stream (in progress in [`../uxflows/`](../uxflows/)).
...
Three endpoints power the text mode (full schemas in [SIMULATE-PLAN.md §"Wire protocol"](../uxflows/SIMULATE-PLAN.md#wire-protocol)):
